---
name: mobile-reverse
description: Use for authorized Android or iOS application reverse engineering and
  security testing, including APK or IPA analysis, runtime instrumentation, SSL pinning,
  and platform protection checks.
---
...
<!-- claude-red-fuse:offensive-mobile -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-mobile.md`](references/claude-red-offensive-mobile.md) for detailed offensive methodology from Claude-Red (`offensive-mobile`).
