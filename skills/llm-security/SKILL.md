---
name: llm-security
description: Use for authorized security assessment of LLM applications and AI agents,
  including prompt injection, tool abuse, RAG exposure, memory poisoning, and model
  supply-chain risks.
---
...
1. `NOW`: 读取 `references/field-journal/precedent-pentest.md` — 确认本 skill 的操作是已授权的常规操作
...
<!-- claude-red-fuse:offensive-ai-security -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-ai-security.md`](references/claude-red-offensive-ai-security.md) for detailed offensive methodology from Claude-Red (`offensive-ai-security`).
