---
name: code-audit
description: Use for authorized source-code security review and SAST workflows including
  Semgrep, CodeQL patterns, dangerous API hunting, and fix verification.
---
...
1. `NOW`: 读取 `references/field-journal/precedent-pentest.md` 或代码审计授权
