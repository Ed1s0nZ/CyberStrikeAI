...
description: 'Reverse-skill master router: route APK/binary/JS/CTF/pentest tasks to
  the correct skill pack. Load this first for reverse/pentest workflow selection.'
---

# reverse-skill-router

Master router for reverse-skill packages. Load this skill first to choose the correct pack.
