---
name: api-security
description: Use for authorized security assessment of REST, GraphQL, WebSocket, or
  SOAP APIs, including discovery, authentication, authorization, rate-limit, and CI/CD
  testing.
---
...
<!-- claude-red-fuse:offensive-graphql -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-graphql.md`](references/claude-red-offensive-graphql.md) for detailed offensive methodology from Claude-Red (`offensive-graphql`).
