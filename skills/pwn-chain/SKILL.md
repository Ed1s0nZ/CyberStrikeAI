...
1. `NOW`: 读取 `references/field-journal/precedent-reverse.md` — 确认本 skill 的操作是已授权的常规操作
2. `NOW`: 确认当前任务是否命中本 skill 的适用范围
3. `NEXT`: 读取 `references/tool-index.md`，校验工具可用性和实际路径
...
<!-- claude-red-fuse:offensive-basic-exploitation -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-basic-exploitation.md`](references/claude-red-offensive-basic-exploitation.md) for detailed offensive methodology from Claude-Red (`offensive-basic-exploitation`).

<!-- claude-red-fuse:offensive-crash-analysis -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-crash-analysis.md`](references/claude-red-offensive-crash-analysis.md) for detailed offensive methodology from Claude-Red (`offensive-crash-analysis`).

<!-- claude-red-fuse:offensive-exploit-development -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-exploit-development.md`](references/claude-red-offensive-exploit-development.md) for detailed offensive methodology from Claude-Red (`offensive-exploit-development`).

<!-- claude-red-fuse:offensive-mitigations -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-mitigations.md`](references/claude-red-offensive-mitigations.md) for detailed offensive methodology from Claude-Red (`offensive-mitigations`).

<!-- claude-red-fuse:offensive-toctou -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-toctou.md`](references/claude-red-offensive-toctou.md) for detailed offensive methodology from Claude-Red (`offensive-toctou`).

<!-- claude-red-fuse:offensive-shellcode -->
## Related methodology (Claude-Red)

See [`references/claude-red-offensive-shellcode.md`](references/claude-red-offensive-shellcode.md) for detailed offensive methodology from Claude-Red (`offensive-shellcode`).
