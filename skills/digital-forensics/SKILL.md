...
description: Use for authorized digital forensics including memory dumps, disk timelines,
  PCAP investigation, artifact triage, and IR evidence preservation.
---
...
1. `NOW`: 读取 `references/field-journal/precedent-pentest.md` 或组织 IR 授权说明
