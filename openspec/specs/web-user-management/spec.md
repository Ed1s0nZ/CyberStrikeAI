...
## Purpose
Define Web RBAC user and access-role administration, including canonical permission catalog management, legacy grant normalization, and session-facing permission introspection.
