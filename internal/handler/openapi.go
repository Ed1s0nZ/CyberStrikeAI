									...
									"schema": map[string]interface{}{
										...
										"items": map[string]interface{}{
											...
											"properties": map[string]interface{}{
												...
												"cmdParam":   map[string]interface{}{"type": "string", "description": "classic 协议命令参数名，默认 cmd"},
												"protocol":   map[string]interface{}{"type": "string", "description": "协议类型", "enum": []string{"classic", "behinder"}},
												"userAgent":  map[string]interface{}{"type": "string", "description": "自定义请求头文本，兼容旧 User-Agent 字符串"},
							...
							"application/json": map[string]interface{}{
								"schema": map[string]interface{}{
									...
									"properties": map[string]interface{}{
										...
										"type":       map[string]interface{}{"type": "string", "description": "Shell类型", "enum": []string{"php", "asp", "aspx", "jsp", "custom"}},
										"method":     map[string]interface{}{"type": "string", "description": "请求方法", "enum": []string{"get", "post"}},
										"cmd_param":  map[string]interface{}{"type": "string", "description": "classic 协议命令参数名，默认 cmd"},
										"protocol":   map[string]interface{}{"type": "string", "description": "协议类型", "enum": []string{"classic", "behinder"}},
										"user_agent": map[string]interface{}{"type": "string", "description": "自定义请求头文本，每行一个 Header；兼容旧 User-Agent 字符串"},
										"remark":     map[string]interface{}{"type": "string", "description": "备注"},
									},
								},
							},
